...
Steps taken for data cleaning
    ...
    2) 739170 of the station names and IDs out of 5.5M records are missing which constitutes 13.21% of the total records. 
       Suprisingly, the data missing was only for electric bikes. Since the geographical latitudes and longitudes are present the nulls did not hinder the analysis.
